...
![](https://img.shields.io/github/repo-size/th2l-devs/hxdiscord_rpc) ![](https://badgen.net/github/open-issues/th2l-devs/hxdiscord_rpc) ![](https://badgen.net/badge/license/MIT/green)
...
```bash
haxelib git hxdiscord_rpc https://github.com/th2l-devs/hxdiscord_rpc.git
```
